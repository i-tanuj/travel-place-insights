      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col px-4 py-8 text-slate-50 md:px-16">
          ...
          <div className="mb-8 flex max-w-3xl flex-1 flex-col justify-end text-slate-50">
            <h1 className="text-xl font-bold md:text-4xl">Voyage Beyond the Horizons</h1>
            <p className="my-4 text-base md:text-lg">
            Embark on a journey through the realms of travel, where tales whisk you away to distant lands. Each corner holds the promise of adventure. Now is the moment to venture forth and discover the wonders of the world!
            </p>
